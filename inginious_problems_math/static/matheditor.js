...
function MathEditor(pid){
    ...
    this.default_toolbar_buttons = ["fraction","square_root","cube_root","root","def_int",'superscript','subscript','multiplication','division','plus_minus','pi','infinity','emptyset','not_equal','greater_equal','less_equal','greater_than','less_than','angle','parallel_to','perpendicular','triangle','parallelogram','round_brackets'];
